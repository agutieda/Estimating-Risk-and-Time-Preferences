function [log_like,rhoX,rhoCHECK,pdfCHECK] = loglike_CTB_DEU_CORR(parameters,Y,menuID,algoList)
% Log-likelihood of DEU model with correlated preferences and CTB data
...
badParameter = sigma_ra<=0 || abs(rho_rada)>=1 ...
