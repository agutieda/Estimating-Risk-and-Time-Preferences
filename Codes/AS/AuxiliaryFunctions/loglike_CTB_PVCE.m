function [log_like,rhoX,rhoCHECK,pdfCHECK] = loglike_CTB_PVCE(parameters,Y,menuID,algoList)
% Log-likelihood of PVCE model with independent preferences and CTB data
