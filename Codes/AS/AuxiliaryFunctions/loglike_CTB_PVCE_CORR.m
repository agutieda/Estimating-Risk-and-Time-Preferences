function [log_like,rhoX,rhoCHECK,pdfCHECK] = loglike_CTB_PVCE_CORR(parameters,Y,menuID,algoList)
% Log-likelihood of PVCE model with correlated preferences and CTB data
