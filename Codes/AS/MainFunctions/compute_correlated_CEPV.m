...
%
% This file:
% - Estimate CEPV-H with correlated preferences by pooling all observations
%
% November 2019
%
...
mu_ra_0     =  27.943   ; % Initial value: mu_ra
sigma_ra_0  =  5.665    ; % Initial value: sigma_ra
alpha_da_0  =  5.2899   ; % Initial value: mu_dr
beta_da_0   =  0.43231  ; % Initial value: sigma_dr
mu_is_0     = -0.065537 ; % Initial value: mu_is
sigma_is_0  =  0.44279  ; % Initial value: sigma_is
rho_rada_0  =  0.18307  ; % Initial value: rho_rada
rho_rais_0  = -0.4882   ; % Initial value: rho_rais
rho_dais_0  = -0.57395  ; % Initial value: rho_dais
...
obj_fun = @(x) -loglike_CTB_CEPV_CORR(x,Y,menuID,algoList);
...
Cov_theta_hat = RobustVarCov(@loglike_CTB_CEPV_CORR, ...
...
[log_like_hat,rhoX,rhoCHECK,pdfCHECK] = loglike_CTB_CEPV_CORR(theta_hat,Y,menuID,algoList);
