...
mu_ra_0     =  0.057281   ; % Initial value: mu_ra
sigma_ra_0  =  0.43997    ; % Initial value: sigma_ra
alpha_da_0  =  3.5457     ; % Initial value: alpha_da
beta_da_0   =  0.39455    ; % Initial value: beta_da
rho_rada_0  = -0.60148    ; % Initial value: rho_rada
...
obj_fun = @(x) -loglike_CTB_DEU_CORR(x,Y,menuID,algoList);
...
Cov_theta_hat = RobustVarCov(@loglike_CTB_DEU_CORR, ...
...
[log_like_hat,rhoX,rhoCHECK,pdfCHECK] = loglike_CTB_DEU_CORR(theta_hat,Y,menuID,algoList);
