...
%
% This file:
% - Estimate PVCE-H with correlated preferences by pooling all observations
%
% November 2019
%
...
mu_ra_0     =  9.9817    ; % Initial value: mu_ra
sigma_ra_0  =  4.0854    ; % Initial value: sigma_ra
alpha_da_0  =  4.7082    ; % Initial value: mu_dr
beta_da_0   =  0.43382   ; % Initial value: sigma_dr
mu_is_0     =  0.10101   ; % Initial value: mu_is
sigma_is_0  =  0.39288   ; % Initial value: sigma_is
rho_rada_0  = -0.33277   ; % Initial value: rho_rada
rho_rais_0  =  0.13446   ; % Initial value: rho_rais
rho_dais_0  = -0.53917   ; % Initial value: rho_dais
...
obj_fun = @(x) -loglike_CTB_PVCE_CORR(x,Y,menuID,algoList);
...
X0 = [mu_ra_0; sigma_ra_0; alpha_da_0; beta_da_0; mu_is_0; sigma_is_0; rho_rada_0; rho_rais_0; rho_dais_0];
...
rho_rada  = theta_hat(7);
rho_rais  = theta_hat(8);
rho_dais  = theta_hat(9);
...
Cov_theta_hat = RobustVarCov(@loglike_CTB_PVCE_CORR, ...
...
std_rho_rada  = std_theta_hat(7);
std_rho_rais  = std_theta_hat(8);
std_rho_dais  = std_theta_hat(9);
...
[log_like_hat,rhoX,rhoCHECK,pdfCHECK] = loglike_CTB_PVCE_CORR(theta_hat,Y,menuID,algoList);
