function CovMat_theta_hat = RobustVarCov_MPL(loglike,x_hat,Y,menuID,hessian,cluster_var,algoList,varargin)
...
if strcmp(estimator,'robust')
    ...
    for k=1:M
        ...
        if mod(k,update_k)==0
            ...
            waitbar(k/M,wait_bar_cluster,['Estimated time left: ' num2str(timeLeft),' min']);
