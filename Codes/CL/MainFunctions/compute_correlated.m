...
%
% This script:
% - Estimate risk and time preferences allowing for correlation
%
% November 2019
%
...
mu_ra_0     =  2.2136      ; % Initial value: mu_ra
sigma_ra_0  =  1.2362      ; % Initial value: sigma_ra
alpha_da_0  =  11.815      ; % Initial value: alpha_da
beta_da_0   =  1.4329      ; % Initial value: beta_da
rho_rada_0  = -0.45327     ; % Initial value: rho_rada
...
obj_fun = @(x) -loglike_MPL_DEU_CORR(x,Y,menuID,algoList);
...
X0 = [mu_ra_0; sigma_ra_0; alpha_da_0; beta_da_0; rho_rada_0];
...
Cov_theta_hat = RobustVarCov_MPL(@loglike_MPL_DEU_CORR, ...
...
log_like_hat = loglike_MPL_DEU_CORR(theta_hat,Y,menuID,algoList);
